...
namespace Drupal\Tests\alexa2\Kernel;
 ...
 * @group alexa
 */
class Alexa2EndpointControllerTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->container->get('state')->set('alexa2.dev_mode', TRUE);
  ...
  public function testLaunchRequest() {
    ...
    $request = Request::create('/alexa2/callback', 'POST', [], [], [], ['HTTP_CONTENT_TYPE' => 'application/json'], $body);
