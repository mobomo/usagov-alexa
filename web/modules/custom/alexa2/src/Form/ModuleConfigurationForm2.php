 ...
 */
class ModuleConfigurationForm2 extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL) {
    ...
    $form['dev_mode'] = [
      ...
      '#default_value' => $this->stateManager->get('alexa2.dev_mode', FALSE),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('alexa2.settings')
      ->set('application_id', $values['application_id'])
      ->save();

    $this->stateManager->set('alexa2.dev_mode', $values['dev_mode']);
  }
