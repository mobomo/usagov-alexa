...
const ReportScamIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.exact.value + "I'm in report scam");
...
const ExactDefinitionIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.exact.value + "I'm in exact definition");
...
console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.financial.value + "I'm in financial definition");
      
console.log("slot after mod:" + financial + "I'm in financial definition");
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.financiera.value + "I'm in Spanish financial definition");
      
      console.log("slot after mod:" + financiera + "I'm in financiera definition");
...
const ImposterDefinitionIntentHandler = {
  ...
  handle(handlerInput) {
    if (handlerInput.requestEnvelope.request.intent.slots["imposter"] !== undefined) {
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.imposter.value + "I'm in imposter definition");
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.impostor.value + "I'm in Spanish impostor definition");
      
      console.log("slot after mod:" + impostor + "I'm in Spanish imposter definition");
...
const FraudDefinitionIntentHandler = {
  ...
  handle(handlerInput) {
    if (handlerInput.requestEnvelope.request.intent.slots["fraud"] !== undefined) {
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.fraud.value + "I'm in fraud definition");
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.fraude.value + "I'm in Spanish fraud definition");
      
      console.log("slot after mod:" + fraude + "I'm in Spanish fraud definition");
...
const MovingDefinitionIntentHandler = {
  ...
  handle(handlerInput) {
    if (handlerInput.requestEnvelope.request.intent.slots["moving"] !== undefined) {
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.moving.value + "I'm in moving definition");
      ...
      console.log("slot before mod:" + handlerInput.requestEnvelope.request.intent.slots.mudanza.value + "I'm in Spanish moving definition");
      
      console.log("slot after mod:" + mudanza + "I'm in Spanish moving definition");
...
const StartOverIntentHandler = {
  ...
  handle(handlerInput) {
    const speakOutput = handlerInput.t("handlerPrompts.StartOverIntentHandler.prompt");
